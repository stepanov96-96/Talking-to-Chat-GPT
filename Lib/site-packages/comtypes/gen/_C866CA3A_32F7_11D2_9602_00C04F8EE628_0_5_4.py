...
__all__ = [
    'SDA_One_Trailing_Space', 'SVF_None', 'SpeechAudioFormatGUIDText',
    'ISpLexicon', 'SSFMOpenForRead', 'DISPID_SRRSaveToMemory',
    'SINoise', 'DISPID_SDKGetlongValue', 'SpResourceManager',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SMSADeviceId',
    'DISPID_SPIEnginePrivateData', 'SPEI_MIN_TTS',
    'SpeechDiscardType', 'eLEXTYPE_PRIVATE20', 'DISPID_SVVoice',
    'ISpeechPhraseInfoBuilder', 'SPEI_RESERVED1',
    'DISPID_SVDisplayUI', 'SREFalseRecognition',
    ...
    'SGRSTTDictation', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SpeechVoiceEvent', 'ISpeechPhraseReplacements',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SAFGetWaveFormatEx',
    'SAFT11kHz8BitMono', 'ISpResourceManager', 'SRADynamic',
    'eLEXTYPE_USER_SHORTCUT', 'SAFT11kHz16BitStereo',
    'DISPID_SWFESamplesPerSec', 'DISPID_SpeechPhraseReplacements',
    'SP_VISEME_7', 'eLEXTYPE_PRIVATE5', 'ISpObjectToken',
    'SRESoundEnd', 'DISPID_SPRsCount', 'ISpeechRecognizer',
    'SP_VISEME_6', 'DISPID_SVSLastBookmark', 'SRTSMLTimeout',
    'DISPID_SVGetProfiles', 'DISPID_SAStatus', 'SVP_10',
    'SPEI_VOICE_CHANGE', 'eLEXTYPE_PRIVATE15', 'SPPHRASEELEMENT',
    'SSFMOpenReadWrite', 'DISPID_SCSBaseStream',
    'SpeechPropertyResourceUsage', 'DISPID_SRCEHypothesis',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SGRsDynamic', 'DISPID_SOTId',
    'SAFTCCITT_ALaw_8kHzStereo', 'SVEStartInputStream',
    'SpeechGrammarTagWildcard', 'DISPID_SGRSTRule', 'SVSFIsNotXML',
    'SWPUnknownWordUnpronounceable', 'SPWAVEFORMATTYPE',
    'DISPID_SpeechLexiconWords', 'ISpeechPhraseAlternates',
    'DISPID_SPEAudioSizeBytes', 'SVP_19',
    'SpeechRetainedAudioOptions',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPRECOCONTEXTSTATUS',
    'DISPID_SOTDisplayUI', 'SpSharedRecoContext',
    'ISpeechPhraseAlternate', 'SAFTGSM610_8kHzMono', 'SDTLexicalForm',
    'ISpeechGrammarRule', 'ISpeechAudioBufferInfo',
    'ISpeechAudioFormat', 'SVP_5', 'SPRS_ACTIVE',
    'SPEI_END_SR_STREAM', 'eLEXTYPE_PRIVATE12', 'SGRSTTTextBuffer',
    'SPBINARYGRAMMAR', 'DISPID_SRCState', 'DISPID_SAEventHandle',
    'SAFT22kHz8BitMono', 'DISPID_SWFEChannels', 'SPSHT_EMAIL',
    'DISPID_SpeechPhraseRule', 'SAFTCCITT_uLaw_22kHzMono',
    'SITooQuiet', 'ISpAudio', 'ISpGrammarBuilder', 'STCLocalServer',
    'SRADefaultToActive', 'SPAS_STOP', 'DISPID_SRCVoice',
    'DISPID_SpeechRecoContext', 'SAFT8kHz16BitMono',
    'ISequentialStream', 'SP_VISEME_5', 'DISPID_SVEStreamEnd',
    'SPRULE', 'SP_VISEME_16', 'DISPID_SRCRetainedAudio',
    'ISpeechObjectTokenCategory', 'Speech_Default_Weight',
    'SPFILEMODE', 'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SGRsAdd',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SpeechGrammarRuleState',
    'SPLO_STATIC', 'SPFM_OPEN_READWRITE', 'DISPID_SGRSTWeight',
    'DISPID_SGRsFindRule', 'DISPID_SPEAudioTimeOffset',
    'SPGRAMMARSTATE', 'SPFM_CREATE_ALWAYS', 'SPSFunction',
    'ISpeechRecognizerStatus', 'SPEI_RECOGNITION',
    'SPAO_RETAIN_AUDIO', 'ISpPhoneticAlphabetConverter',
    'ISpPhraseAlt', 'eWORDTYPE_DELETED', 'SPEI_RESERVED3',
    'DISPID_SRRTTickCount', 'DISPID_SBSWrite',
    'DISPID_SPRuleNumberOfElements', 'SP_VISEME_20',
    'eWORDTYPE_ADDED', 'SpeechCategoryRecognizers',
    'eLEXTYPE_PRIVATE13', 'DISPID_SVSLastResult',
    'SPDKL_LocalMachine', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPSERIALIZEDPHRASE', 'SpeechDisplayAttributes',
    'DISPID_SPIEngineId', 'SpMMAudioIn',
    'DISPID_SPPBRestorePhraseFromMemory', 'SGDSInactive',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SPEDisplayText',
    'DISPID_SpeechGrammarRule', 'ISpeechLexicon',
    'SDA_Two_Trailing_Spaces', 'SPGS_DISABLED', 'SVSFNLPMask',
    'STSF_LocalAppData', 'SpSharedRecognizer', 'DISPID_SPPsCount',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SLWsItem',
    'DISPID_SVESentenceBoundary', 'SDA_No_Trailing_Space',
    'DISPID_SVSInputSentencePosition', 'ISpSerializeState',
    'SRAORetainAudio', 'SPEI_VISEME', 'DISPID_SDKDeleteValue',
    'ISpeechGrammarRuleState', 'SpCompressedLexicon',
    'SpPhraseInfoBuilder', 'DISPID_SOTsItem', 'ISpeechLexiconWord',
    'DISPID_SDKSetStringValue', 'SPDATAKEYLOCATION', 'SGRSTTEpsilon',
    'SP_VISEME_12', 'SPSEMANTICFORMAT', 'SpeechRecognizerState',
    'SPVISEMES', 'SVEPhoneme', 'DISPID_SFSOpen',
    'DISPID_SVSInputWordLength', 'DISPID_SOTGetAttribute',
    'SpeechEngineConfidence', 'SPBO_TIME_UNITS',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SRCPause', 'SVSFDefault',
    'ISpObjectTokenCategory', 'DISPID_SOTCEnumerateTokens',
    'SpeechEmulationCompareFlags', 'SGRSTTRule',
    'DISPID_SVGetAudioOutputs', 'DISPID_SOTCSetId', 'SPEI_RESERVED5',
    'ISpeechPhraseElements', 'SPINTERFERENCE_NONE', 'ISpNotifySink',
    'DISPID_SpeechPhraseBuilder', 'ISpeechBaseStream',
    'SPEI_TTS_BOOKMARK', 'SPEI_PHRASE_START',
    'DISPIDSPTSI_ActiveOffset', 'SDTRule', 'DISPID_SVWaitUntilDone',
    'SRERecoOtherContext', 'DISPID_SASNonBlockingIO', 'SPLOADOPTIONS',
    'DISPID_SOTMatchesAttributes',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SRCRequestedUIType',
    ...
    'ISpRecoGrammar2', 'SPWT_LEXICAL', 'DISPID_SpeechPhraseRules',
    'SVSFlagsAsync', 'DISPID_SDKEnumValues', 'SFTInput',
    'SpeechRecognitionType', 'SpTextSelectionInformation',
    'DISPID_SGRSRule', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SPIGrammarId', 'SVP_7', 'DISPID_SPIStartTime',
    'SDTReplacement', 'ISpeechRecoResult2', 'SDKLDefaultLocation',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPSHT_Unknown', 'SVSFIsFilename',
    'ISpVoice', 'SPVPRI_NORMAL', 'SAFT22kHz16BitStereo',
    'SAFT8kHz8BitStereo', '_ISpeechVoiceEvents',
    'SPEI_SR_RETAINEDAUDIO', 'DISPIDSPTSI_SelectionLength',
    'SRSActiveAlways', 'SPXMLRESULTOPTIONS', 'SDTAlternates',
    'DISPID_SPILanguageId', 'SGDSActiveUserDelimited',
    'DISPID_SWFEBlockAlign', 'SPCATEGORYTYPE',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SDKDeleteKey',
    'SAFT24kHz8BitMono', 'SPEI_TTS_PRIVATE', 'eLEXTYPE_PRIVATE9',
    'DISPID_SVEVoiceChange', 'DISPID_SRSetPropertyNumber',
    'DISPID_SPPValue', 'SpNullPhoneConverter', 'SpeechUserTraining',
    'DISPID_SGRsItem', 'SpeechCategoryAudioIn',
    'DISPID_SPARecoResult', 'DISPID_SPPFirstElement',
    'SGDSActiveWithAutoPause', 'SPLO_DYNAMIC', 'ISpeechRecoContext',
    'SASStop', 'SPEI_REQUEST_UI', 'SECHighConfidence',
    'DISPID_SREmulateRecognition', 'SP_VISEME_18', 'DISPID_SVVolume',
    'SPEI_START_SR_STREAM', 'DISPID_SpeechRecoResult2',
    'SP_VISEME_10', 'DISPID_SVSLastBookmarkId',
    ...
    'SpeechPropertyResponseSpeed', 'SVP_11', 'SRARoot',
    'DISPID_SABIEventBias', 'DISPID_SPCIdToPhone', 'UINT_PTR',
    'LONG_PTR', 'SPPS_SuppressWord', 'SREPrivate',
    'DISPID_SpeechPhoneConverter', 'DISPID_SPIAudioSizeBytes',
    'SITooSlow', 'DISPID_SGRSTType', 'DISPID_SGRAttributes',
    'SpeechPropertyAdaptationOn',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SLODynamic', 'SAFTText',
    'DISPID_SDKEnumKeys', 'SpeechTokenContext',
    'DISPID_SPIAudioSizeTime', 'SPLEXICONTYPE',
    'SPRST_INACTIVE_WITH_PURGE', 'SpeechLexiconType',
    'SpPhoneticAlphabetConverter', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SMSGetData', 'SDKLCurrentUser', 'ISpeechGrammarRules',
    'SSTTTextBuffer', 'DISPID_SVSkip', 'SpPhoneConverter',
    'SPEVENTSOURCEINFO', 'DISPID_SLPPartOfSpeech',
    'DISPID_SRCEPropertyStringChange', 'eLEXTYPE_PRIVATE10',
    'SPRST_NUM_STATES', 'ISpRecoContext', 'DISPID_SpeechMMSysAudio',
    'DISPID_SGRClear', 'SRTExtendableParse', 'DISPID_SASetState',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SVEStreamStart', 'SPPS_Function',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SpeechPhraseElements',
    'SPEI_MIN_SR', 'DISPID_SRGRecoContext', 'SAFTADPCM_44kHzStereo',
    'DISPID_SOTGetDescription', 'DISPID_SASCurrentDevicePosition',
    'SP_VISEME_14', 'DISPID_SGRSTPropertyValue',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SpWaveFormatEx',
    'DISPID_SLWLangId', 'SAFT44kHz16BitStereo', 'SPCT_COMMAND',
    'ISpeechPhraseElement', 'SSSPTRelativeToStart',
    'DISPID_SRDisplayUI', 'SpeechAudioFormatGUIDWave',
    'SPCS_DISABLED', 'SAFT44kHz16BitMono', 'SAFTNoAssignedFormat',
    'SAFTCCITT_ALaw_11kHzStereo', 'SVSFIsXML', 'SpeechTokenKeyUI',
    'SpeechPropertyLowConfidenceThreshold', 'SPADAPTATIONRELEVANCE',
    'SAFTADPCM_8kHzStereo', 'ISpeechLexiconWords',
    'DISPID_SVAudioOutputStream', 'SPRULESTATE', 'DISPID_SGRId',
    'SGRSTTWord', 'DISPID_SRGetRecognizers', 'SRAONone',
    'DISPID_SRCEInterference', 'Speech_StreamPos_RealTime',
    'SP_VISEME_21', 'SDTDisplayText', 'DISPID_SVEAudioLevel',
    'DISPID_SRAudioInputStream', 'DISPID_SPCPhoneToId',
    'Speech_Max_Word_Length', 'DISPID_SGRsCommit', 'DISPID_SLPLangId',
    'SVP_12', 'DISPID_SRCERecognition', 'DISPID_SPRuleConfidence',
    'SINone', 'DISPID_SDKSetBinaryValue', 'SPGS_EXCLUSIVE',
    'ISpeechXMLRecoResult', 'SAFTTrueSpeech_8kHz1BitMono', 'SLTApp',
    'SPAS_RUN', 'DISPID_SpeechLexiconWord',
    'DISPID_SPERetainedStreamOffset', 'SPEI_SR_BOOKMARK',
    'DISPID_SpeechLexicon', 'ISpeechFileStream', 'SPBO_PAUSE',
    'SRAInterpreter', 'ISpeechPhraseProperties', 'SpeechVoiceEvents',
    'DISPID_SpeechRecognizer', 'SAFT16kHz16BitStereo',
    'SRSEIsSpeaking', 'DISPID_SRGDictationUnload',
    'DISPID_SVSpeakStream', 'DISPID_SVResume', 'SPVPRIORITY',
    'SPEI_MAX_SR', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SWFEBitsPerSample', 'DISPID_SVSInputWordPosition',
    'SBONone', 'SAFTCCITT_uLaw_8kHzMono', 'SAFT32kHz16BitStereo',
    'DISPID_SRIsUISupported', 'eLEXTYPE_PRIVATE8',
    'SAFT32kHz16BitMono', 'SREStateChange', 'SPPARTOFSPEECH',
    'DISPID_SPRulesItem', 'SGSExclusive', 'SpUnCompressedLexicon',
    'SFTSREngine', 'SpeechFormatType', 'DISPID_SRRSetTextFeedback',
    'SVP_18', 'ISpeechPhraseInfo', 'SAFTCCITT_ALaw_8kHzMono',
    'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SGRSTTWildcard',
    'DISPID_SRRecognizer', 'SECFEmulateResult', 'ISpMMSysAudio',
    'eLEXTYPE_APP', 'SPSHORTCUTPAIR', 'SRCS_Enabled', 'DISPID_SOTCId',
    'SPRS_INACTIVE', 'SASPause', 'SPBOOKMARKOPTIONS',
    'DISPID_SVEventInterests', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SRRAudio', 'SAFT16kHz8BitMono', 'SAFTGSM610_11kHzMono',
    'DISPID_SpeechWaveFormatEx', 'SVSFParseSapi', 'DISPID_SOTDataKey',
    'SRSEDone', 'SPPHRASE', 'SVSFNLPSpeakPunc', 'SPSNoun', 'SVP_16',
    'DISPID_SPEDisplayAttributes', 'DISPID_SLWs_NewEnum',
    'DISPID_SpeechObjectToken', 'SAFTCCITT_ALaw_22kHzMono',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SLPSymbolic',
    'SPRECOGNIZERSTATUS', 'SpMMAudioEnum', 'DISPID_SPPName',
    'SpeechEngineProperties', 'ISpeechDataKey',
    'SpeechAudioProperties', 'STSF_CommonAppData', 'SPVPRI_OVER',
    'DISPID_SpeechBaseStream', 'DISPID_SRGCmdLoadFromObject',
    'SGSDisabled', 'DISPID_SGRSTPropertyId',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SPACommit', 'SPAO_NONE',
    'DISPID_SPPNumberOfElements', 'SVSFParseAutodetect',
    'DISPID_SGRSAddRuleTransition', 'SVP_4', 'tagSTATSTG',
    'DISPID_SRGetPropertyNumber', 'DISPID_SASFreeBufferSpace',
    'SpeechRecoProfileProperties', 'DISPID_SDKOpenKey',
    'SECNormalConfidence', 'SpeechWordType', 'SpeechStreamFileMode',
    'DISPID_SLGetPronunciations', 'SpeechAddRemoveWord',
    'SpInProcRecoContext', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'ISpeechRecoResultTimes', 'SRSInactive', 'SVEAudioLevel',
    'DISPID_SRCCreateGrammar', 'Speech_StreamPos_Asap',
    'DISPID_SPAsItem', 'DISPID_SpeechPhraseProperties', 'SPPS_Verb',
    'SP_VISEME_13', 'DISPID_SPPId', 'SPCT_SUB_DICTATION',
    'SRATopLevel', 'DISPID_SPAsCount', 'DISPID_SGRSAddWordTransition',
    'DISPID_SLAddPronunciationByPhoneIds',
    'SpeechPropertyHighConfidenceThreshold', 'SAFTADPCM_11kHzStereo',
    'SPRS_ACTIVE_USER_DELIMITED', 'SASRun', 'DISPID_SADefaultFormat',
    'DISPID_SRRSpeakAudio', 'SAFTADPCM_22kHzStereo', 'SREAudioLevel',
    'SP_VISEME_8', 'DISPID_SPPEngineConfidence',
    'DISPID_SpeechPhraseProperty', 'DISPID_SRSetPropertyString',
    'DISPID_SLGenerationId', 'ISpShortcut', 'DISPID_SGRsCount',
    'SGLexicalNoSpecialChars', 'DISPID_SPRNumberOfElements',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SMSSetData',
    'DISPID_SGRs_NewEnum', 'DISPID_SPIRetainedSizeBytes',
    'SpeechStreamSeekPositionType', 'SPEI_PHONEME',
    'SSFMCreateForWrite', 'DISPIDSPRG',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SAFType',
    'SPCONTEXTSTATE', 'SECFIgnoreKanaType', 'SECFDefault',
    'DISPID_SPIReplacements', 'SRTAutopause', 'SRTReSent',
    'ISpeechRecoResult', 'SpeechCategoryVoices', 'DISPID_SRRTimes',
    'ISpStreamFormat', 'DISPID_SRSClsidEngine', 'SPWORD',
    'DISPID_SLWPronunciations', 'DISPID_SPEsItem', 'SPCS_ENABLED',
    'SPGS_ENABLED', 'SPFM_CREATE', 'SVP_14', 'SRERequestUI',
    'SVEBookmark', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SOTGetStorageFileName', 'DISPID_SPPsItem',
    'DISPID_SABufferInfo', 'SpVoice', 'ISpeechMMSysAudio',
    'SPRST_INACTIVE', 'SP_VISEME_4', 'STCInprocServer',
    'DISPID_SPEs_NewEnum', 'SPPS_NotOverriden', 'SAFT32kHz8BitStereo',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SRAudioInput',
    'SAFT12kHz8BitStereo', 'SPCT_SUB_COMMAND', 'DISPID_SGRSTsItem',
    'SpCustomStream', 'SPCT_SLEEP', 'SPPS_Interjection',
    'SP_VISEME_1', 'SBOPause', 'DISPID_SRProfile',
    ...
    'SPEI_HYPOTHESIS', 'DISPID_SRCEEndStream', 'DISPID_SVEWord',
    'ISpeechMemoryStream', 'SpeechVoiceCategoryTTSRate', 'SPPS_LMA',
    'ISpRecoGrammar', 'DISPID_SRCSetAdaptationData',
    'SpeechInterference', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPSInterjection', 'SpeechVoicePriority', 'ISpRecognizer3',
    'SPEI_SR_AUDIO_LEVEL', 'SPEI_SOUND_END', 'SVEPrivate',
    'ISpeechVoice', 'SpeechRuleAttributes', 'ISpeechRecoGrammar',
    'DISPID_SRCEPhraseStart', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SBSSeek',
    'DISPID_SRCEBookmark', 'ISpeechPhraseRules',
    'SpeechTokenKeyAttributes', 'DISPID_SPERetainedSizeBytes',
    'SpMMAudioOut', '_SPAUDIOSTATE', 'DISPID_SpeechFileStream',
    'DISPID_SpeechAudio', 'SPSEMANTICERRORINFO', 'SPSHT_OTHER',
    'SREAdaptation', 'SVEEndInputStream', 'SAFT11kHz16BitMono',
    'ISpProperties', 'SpeechMicTraining', 'SAFT22kHz8BitStereo',
    'SGLexical', 'SPEI_START_INPUT_STREAM', 'ISpeechAudioStatus',
    'SPEI_INTERFERENCE', 'DISPID_SPIElements', 'SVESentenceBoundary',
    'DISPID_SGRsCommitAndSave', 'SPEI_RESERVED2', 'SPAUDIOSTATE',
    'ISpeechGrammarRuleStateTransition', 'SAFTGSM610_22kHzMono',
    'DISPID_SpeechVoice', 'DISPID_SRGReset', 'DISPID_SVEBookmark',
    'DISPID_SGRSTText', 'SPPS_Noun', 'DISPID_SABIBufferSize',
    'SPRST_ACTIVE_ALWAYS', 'SPSUnknown', 'DISPID_SRCESoundEnd',
    'SPWORDPRONOUNCEABLE', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SVEPhoneme', 'SVP_17', 'DISPID_SPRulesCount',
    'DISPID_SAVolume', 'SPEI_RESERVED6', 'SpInprocRecognizer',
    'SVP_3', 'eLEXTYPE_MORPHOLOGY', 'SAFT12kHz16BitStereo',
    'SpeechAudioFormatType', 'SpeechCategoryPhoneConverters',
    'SVEVoiceChange', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SPEAudioSizeTime', 'DISPID_SpeechPhraseElement',
    'eLEXTYPE_PRIVATE3', 'DISPID_SRCERecognitionForOtherContext',
    'SDKLLocalMachine', 'SGDisplay',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRRAudioFormat', 'DISPID_SRCERequestUI',
    'DISPID_SLPsCount', 'IInternetSecurityManager', 'SRESoundStart',
    'ISpPhoneConverter', 'DISPID_SLPPhoneIds', 'DISPID_SLWType',
    'SREStreamEnd', 'SPPS_RESERVED4', 'SDTAudio',
    'DISPID_SGRSTPropertyName', 'DISPID_SpeechRecoResultTimes',
    'ISpEventSink', 'SPAS_CLOSED', 'SPAS_PAUSE', 'SVSFPersistXML',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SASState',
    'DISPID_SPIGetDisplayAttributes', 'SECFNoSpecialChars',
    'SSFMCreate', 'DISPID_SPRuleFirstElement', 'SPINTERFERENCE_NOISE',
    'SP_VISEME_19', 'SP_VISEME_3',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SRRPhraseInfo',
    'SpeechRuleState', 'DISPID_SLGetWords',
    'DISPIDSPTSI_ActiveLength', 'SAFTGSM610_44kHzMono',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SpStream',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SLWWord', 'SVP_21',
    'eLEXTYPE_PRIVATE2', 'SAFT32kHz8BitMono', 'SVSFVoiceMask',
    'DISPID_SPELexicalForm', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SPPs_NewEnum', 'SVEViseme', 'SPINTERFERENCE_TOOSLOW',
    'SPEI_ADAPTATION', 'DISPID_SPRFirstElement', 'SpAudioFormat',
    'SWPKnownWordPronounceable', 'SRTEmulated',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SMSALineId',
    'SPSNotOverriden', 'SPXRO_Alternates_SML', 'DISPID_SRGCommit',
    'SpeechBookmarkOptions', 'SPSERIALIZEDRESULT',
    'DISPID_SLPs_NewEnum', 'DISPID_SRCEFalseRecognition',
    'SpMemoryStream', 'SPINTERFERENCE', 'SPWT_PRONUNCIATION',
    'DISPID_SBSRead', 'SPINTERFERENCE_LATENCY_WARNING',
    'SAFT24kHz16BitStereo', 'DISPID_SVIsUISupported',
    'ISpeechLexiconPronunciations', 'STSF_AppData', 'SPAR_High',
    'SPEI_UNDEFINED', 'DISPID_SOTCategory',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPWORDTYPE',
    'SpeechTokenIdUserLexicon', 'SPPHRASEREPLACEMENT',
    'ISpRecoCategory', 'DISPID_SRCResume', 'DISPID_SPPChildren',
    'SVPNormal', 'SWTAdded', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SWFEAvgBytesPerSec', 'SpeechCategoryAppLexicons',
    'ISpStream', 'DISPID_SOTs_NewEnum', 'DISPID_SPEEngineConfidence',
    'ISpXMLRecoResult', 'DISPID_SpeechGrammarRules', 'IEnumString',
    'SWTDeleted', 'SpStreamFormatConverter', 'SpeechLoadOption',
    'DISPID_SGRName', 'DISPID_SOTCGetDataKey', 'DISPID_SLWsCount',
    'DISPID_SVEViseme', 'DISPID_SRCEEnginePrivate',
    'eLEXTYPE_PRIVATE11', 'SAFT48kHz8BitMono', 'SPSModifier',
    'SLOStatic', 'SP_VISEME_0', 'IEnumSpObjectTokens',
    'ISpeechLexiconPronunciation', 'SpFileStream', 'SPPS_Unknown',
    'SREStreamStart', 'SAFT16kHz8BitStereo', 'SPEI_WORD_BOUNDARY',
    'SpeechAudioVolume', 'SPSVerb', 'DISPID_SVSVisemeId',
    'SPCT_DICTATION', 'DISPID_SGRInitialState',
    'SPWORDPRONUNCIATIONLIST', 'SpeechVisemeType', 'SVP_1',
    'SPWF_INPUT', 'DISPID_SPRDisplayAttributes', 'SAFT24kHz16BitMono',
    'eLEXTYPE_RESERVED7', 'SpeechVoiceSkipTypeSentence',
    ...
    'SPWT_DISPLAY', 'SPPS_RESERVED1', 'DISPID_SRCESoundStart',
    'DISPID_SPRuleName', 'IStream', 'SAFTADPCM_8kHzMono',
    'SP_VISEME_17', 'SpNotifyTranslator',
    'DISPID_SpeechObjectTokenCategory', 'eLEXTYPE_PRIVATE14',
    'ISpeechObjectTokens', 'eLEXTYPE_RESERVED8', 'SPRECORESULTTIMES',
    'DISPID_SOTCreateInstance', 'SPEI_RECO_STATE_CHANGE',
    'SAFT24kHz8BitStereo', 'SVP_9', 'ISpEventSource',
    'DISPID_SPEActualConfidence', 'SDKLCurrentConfig',
    'SpeechVoiceSpeakFlags', 'SPSSuppressWord',
    'DISPID_SRRRecoContext', 'SPWORDLIST', 'SpeechRunState',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SRGId',
    'DISPID_SRGCmdSetRuleIdState', 'STCAll',
    'SpeechDictationTopicSpelling', 'SpeechAudioState', 'SPAR_Low',
    'SREHypothesis', 'SREPropertyNumChange',
    'SpeechGrammarRuleStateTransitionType', 'eLEXTYPE_PRIVATE19',
    'SpeechGrammarTagDictation', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SVGetVoices', 'SVP_15', 'DISPID_SRGCmdSetRuleState',
    'STCRemoteServer', 'SPDKL_CurrentUser', 'SREPropertyStringChange',
    'DISPID_SPEPronunciation', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SABufferNotifySize', 'DISPID_SRCEAdaptation',
    'IInternetSecurityMgrSite', 'SAFT22kHz16BitMono',
    ...
    'DISPID_SRRAlternates', 'SITooFast', 'SSTTDictation',
    'SAFTCCITT_uLaw_44kHzMono', 'SPBO_AHEAD',
    'DISPID_SLRemovePronunciation', 'SPEVENTENUM', 'SDTProperty',
    'DISPID_SRRTStreamTime', 'ISpPhoneticAlphabetSelection',
    'STCInprocHandler', 'SDTPronunciation', 'eLEXTYPE_PRIVATE16',
    'WAVEFORMATEX', 'DISPID_SPPConfidence', '_RemotableHandle',
    'DISPID_SPIGetText', 'DISPID_SDKSetLongValue', 'SVP_13',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPEVENT', 'SPPS_Modifier',
    'eLEXTYPE_PRIVATE7', 'SVP_6', 'DISPID_SPRText',
    'DISPID_SVAudioOutput', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SLAddPronunciation', 'SAFT12kHz16BitMono',
    'DISPID_SpeechAudioBufferInfo', 'SVF_Stressed', 'SVP_20',
    'SRERecognition', 'DISPID_SVStatus', 'DISPID_SGRAddState',
    'SAFTDefault', 'DISPID_SRState', 'DISPID_SGRSTsCount',
    'SPPROPERTYINFO', 'SWPUnknownWordPronounceable',
    'DISPID_SpeechLexiconPronunciation', 'SECLowConfidence',
    'DISPID_SRCEAudioLevel', 'DISPID_SOTIsUISupported',
    'DISPID_SPANumberOfElementsInResult',
    'ISpeechGrammarRuleStateTransitions', 'ISpRecognizer',
    'SPXRO_SML', 'SECFIgnoreWidth', 'DISPID_SRSSupportedLanguages',
    'SPGRAMMARWORDTYPE', 'DISPID_SBSFormat', 'DISPID_SDKCreateKey',
    'SVSFParseSsml', 'SVEAllEvents', 'DISPID_SVGetAudioInputs',
    'SPSMF_UPS', 'SPSLMA', 'ISpeechPhoneConverter',
    'eLEXTYPE_LETTERTOSOUND', 'eLEXTYPE_PRIVATE18', 'SVF_Emphasis',
    'SAFTNonStandardFormat', 'DISPID_SPRuleId', 'SPRECOSTATE',
    'SpLexicon', 'SPWORDPRONUNCIATION', 'DISPID_SPEsCount',
    'DISPID_SpeechObjectTokens', 'SREBookmark',
    'DISPID_SpeechRecoResult', 'SpeechRegistryUserRoot',
    'DISPID_SOTCDefault', 'SVP_2', 'SAFT8kHz8BitMono',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SVPriority', 'SREAllEvents', 'SAFT16kHz16BitMono',
    'DISPID_SPAPhraseInfo', 'ISpRecognizer2', 'SLTUser',
    'SPEI_MAX_TTS', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SpeechVoiceStatus', 'SSTTWildcard', 'SASClosed',
    'SpeechTokenValueCLSID', 'DISPID_SLPsItem',
    'DISPID_SpeechAudioFormat', 'DISPID_SPRsItem', 'SPFM_NUM_MODES',
    'SP_VISEME_2', 'SPPS_RESERVED3',
    ...
    'eLEXTYPE_RESERVED10', 'DISPIDSPTSI',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    '__MIDL_IWinTypes_0009', 'SREInterference',
    'DISPID_SpeechAudioStatus', 'SAFT8kHz16BitStereo', 'SITooLoud',
    'eLEXTYPE_USER', 'DISPID_SpeechCustomStream', 'ISpPhrase',
    'SAFT48kHz16BitStereo', 'DISPID_SRRTLength',
    'ISpeechCustomStream', 'SGDSActive', 'SPEI_SR_PRIVATE',
    'SpeechPartOfSpeech', 'ISpRecoResult', 'DISPID_SPAs_NewEnum',
    'DISPID_SMSAMMHandle', 'DISPID_SPRuleChildren',
    'DISPID_SRCEStartStream', 'ISpeechTextSelectionInformation',
    ...
    'SPVPRI_ALERT', 'eLEXTYPE_PRIVATE6', 'SpeechDataKeyLocation',
    'SPAUDIOBUFFERINFO', 'DISPID_SVPause', 'DISPID_SVRate',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SVSPhonemeId', 'SPAR_Medium',
    'SAFTADPCM_22kHzMono', 'SPDKL_CurrentConfig',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SGRSTNextState',
    'DISPID_SpeechDataKey', 'ISpeechObjectToken',
    'eLEXTYPE_RESERVED6', 'eLEXTYPE_RESERVED4', 'SPPHRASERULE',
    'ISpeechResourceLoader', 'SAFTADPCM_44kHzMono',
    'DISPID_SPRuleParent', 'DISPID_SDKGetBinaryValue',
    'eLEXTYPE_PRIVATE17', 'ISpeechPhraseReplacement',
    'STSF_FlagCreate', 'SAFT48kHz8BitStereo', 'SpeechGrammarState',
    'SAFTADPCM_11kHzMono', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SPTEXTSELECTIONINFO', 'SRAImport', 'DISPID_SRIsShared',
    'DISPID_SLGetGenerationChange', 'SGSEnabled', 'DISPID_SPCLangId',
    'SECFIgnoreCase', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPPHRASEPROPERTY', 'SRAExport', 'SpeechRecoEvents',
    'DISPID_SRCEventInterests', 'DISPID_SVSpeak', 'SPRST_ACTIVE',
    'SpShortcut', 'SpeechCategoryRecoProfiles',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SPIProperties', 'SRSActive',
    'DISPID_SVSLastStreamNumberQueued', 'eLEXTYPE_RESERVED9',
    'SpeechCategoryAudioOut', 'SpeechVisemeFeature', 'SPAUDIOOPTIONS',
    'DISPID_SRGDictationLoad', 'DISPID_SRGetPropertyString',
    'DISPID_SVEEnginePrivate', 'DISPID_SOTRemove',
    'SRSInactiveWithPurge', 'DISPID_SAFGuid', 'ISpDataKey',
    'SVPAlert', 'DISPID_SGRAddResource', 'DISPID_SRSAudioStatus',
    'DISPID_SPRules_NewEnum', 'SP_VISEME_11', 'DISPID_SPIRule',
    'DISPID_SRRGetXMLResult', 'tagSPPROPERTYINFO',
    'DISPID_SpeechMemoryStream', 'ISpNotifySource',
    'SAFT44kHz8BitStereo', 'DISPID_SOTSetId',
    'DISPID_SVSInputSentenceLength', 'DISPID_SGRSTransitions',
    'SVPOver', 'DISPID_SASCurrentSeekPosition',
    'ISpeechPhraseProperty', 'SINoSignal', 'SPDKL_DefaultLocation',
    'DISPID_SRCRecognizer', 'SPAR_Unknown', 'ISpObjectWithToken',
    'SAFT11kHz8BitStereo', 'DISPID_SLPType', 'SGPronounciation',
    'DISPID_SRGState', 'ISpeechAudio', 'SVEWordBoundary',
    'eLEXTYPE_PRIVATE1', 'ISpeechWaveFormatEx', 'DISPID_SRStatus',
    'DISPID_SFSClose', 'SPSHORTCUTTYPE', 'SPPS_RESERVED2',
    'DISPID_SRCRetainedAudioFormat', 'SPEI_SENTENCE_BOUNDARY',
    'SVSFUnusedFlags', 'SDTAll', 'ISpStreamFormatConverter',
    'SpeechGrammarWordType', 'SPEI_SOUND_START', 'SVSFParseMask',
    'SP_VISEME_15', 'DISPID_SRCBookmark', 'ISpeechVoiceStatus',
    'DISPID_SPISaveToMemory', 'DISPID_SRGRules',
    'SpeechSpecialTransitionType', 'DISPID_SpeechPhraseInfo',
    'SPBO_NONE', 'SPSHORTCUTPAIRLIST', 'SpObjectTokenCategory',
    'SpeechAllElements', 'DISPID_SVSRunningState',
    'eLEXTYPE_PRIVATE4', 'SVP_0', 'SpeechRecoContextState', 'SVP_8'
]
